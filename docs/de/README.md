...
AVR-3310, AVR-3311,  AVR-3312, AVR-3313, AVR-3808A, AVR-4310, AVR-4311, AVR-4810, AVR-X1100W, AVR-X1200W,  AVR-X1300W, AVR-X1400H, AVR-X1500H, AVR-X1600H, AVR-X2000,	AVR-X2100W,	AVR-X2200W,	AVR-X2300W,	AVR-X2400H,	AVR-X2500H, AVR-X2600H, AVR-X2700H, AVR-X2800H, AVR-X2900H, AVR-X3000, AVR-X3400H, AVR-X3500H, AVR-X3700H, AVR-X3800H, AVR-X3900H, AVR-X4000, AVR-X4100W,
AVR-X4200W, AVR-X4300H, AVR-X4400H, AVR-X4500H, AVR-X4700H, AVR-X4800H, AVR-X5200W, AVR-X6200W, AVR-X6300H, AVR-X6400H, AVR-X6500H, AVR-X6700H, AVR-X7200W, AVR-X7200WA, AVC-X8500H, AVR-S750H, AVR-S960H, AVR-S970H, AVR-S980H, DRA-N5, RCD-N8
...
Marantz-CINEMA 50, Marantz-CINEMA 40, Marantz-AV20, Marantz-AV30
...
**Der empfohlene Weg zum Schalten ist `RequestAction`.** Jede Statusvariable des
Moduls, die nicht reine Anzeige ist, lässt sich damit direkt setzen — ohne eine
modulspezifische Funktion zu kennen:

```php
RequestAction(<VariablenID>, <Wert>);
```

Beispiel: Für die Variable „Dimmer" (Display-Helligkeit) bedeutet `<Wert>`
0 = Off, 1 = Dark, 2 = Dim, 3 = Bright.

Die nachfolgend aufgeführten Funktionen bleiben unverändert nutzbar. Sie sind
vor allem dort nötig, wo es keine Statusvariable gibt (z. B. Menü- und
Netzwerk-Navigation) oder wo mehrere Parameter gebraucht werden.
